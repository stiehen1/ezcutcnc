            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  { key: "ramp",         label: "Ramp",             color: "text-indigo-300 border-indigo-500/60", recommended: false,                             slotOnly: false, hideInSlot: false, tooltip: "Zigzag ramp — tool moves laterally while descending at 2–5°, reverses direction, and repeats until it reaches full depth. Think of it like a slalom going deeper with each pass. Simpler than helical; supported by all CAM systems. Use reduced entry feed (40–50% of full feed). Good fallback when the pocket is too small for a helix or helical clearance is tight." },
