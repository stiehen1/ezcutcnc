    ...
    <div className="mx-auto w-full max-w-6xl p-3 sm:p-4">
      ...
      <div className="mt-6 pt-4 border-t border-border flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black uppercase bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: "'Oxanium', sans-serif", letterSpacing: "0.1em" }}>EZcutCNC</span>
        </div>
