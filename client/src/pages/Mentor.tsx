...
<div class="header">
  <div style="display:flex;align-items:center;gap:10px">
    ...
    <span style="font-size:18px;font-weight:800;letter-spacing:3px;color:#ea6c00">EZCutCNC</span>
  </div>
    ...
    <div className="mx-auto w-full max-w-6xl p-3 sm:p-4">
        ...
        <CardHeader className="pt-4 pb-4">
          ...
          <div className="flex justify-center items-center gap-4 pb-2">
            ...
            <div className="flex flex-col gap-0.5">
              <span className="text-3xl font-black bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: "'Oxanium', sans-serif", letterSpacing: "0.1em" }}>EZcutCNC</span>
      ...
      <div className="mt-6 pt-4 border-t border-border flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: "'Oxanium', sans-serif", letterSpacing: "0.1em" }}>EZcutCNC</span>
        </div>
