...
const OPERATION_HELP: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  ...
  keyseat: {
    ...
    sections: [
      ...
      { heading: "5. Coolant", body: "Through-spindle coolant (TSC — coolant pumped through the spindle and out of the tool, right at the cutting edge; TSC300 and TSC1000 are the ~300 psi and ~1000 psi options) is ideal for keyseat work — chips have nowhere to go in a full-slot engagement and recutting chips is the #1 cause of breakage. High-pressure flood aimed directly into the cut is the next best option. Air blast assist is very effective. Avoid light mist only — it won't evacuate chips reliably in a closed slot." },
