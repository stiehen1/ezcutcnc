    ...
    <tr><td align="center" style="padding:28px 12px;">
      <table role="presentation" width="620" cellpadding="0" cellspacing="0" style="width:620px;max-width:620px;background:#ffffff;border:1px solid #e5e7eb;">
        ...
        <tr><td style="padding:24px 28px;">
          ...
          <!-- Job spec table -->
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:20px;border:1px solid #eee;">
            <tr><td style="${cellL}width:42%;">Material</td><td style="${cellR}">${material || "—"}</td></tr>
            <tr style="${rowGray}"><td style="${cellL}">Operation</td><td style="${cellR}">${operation || "—"}</td></tr>
            <tr><td style="${cellL}">Tool Diameter</td><td style="${cellR}">${fmtFour(toolDia)}"</td></tr>
            ${feedIpm ? `<tr style="${rowGray}"><td style="${cellL}">Feed Rate</td><td style="${cellR}">${fmtD(feedIpm)} IPM</td></tr>` : ""}
            ${ccEdp ? `<tr><td style="${cellL}">CC EDP</td><td style="${cellR}">${ccEdp}</td></tr>` : ""}
            ${compEdp ? `<tr style="${rowGray}"><td style="${cellL}">Competitor EDP</td><td style="${cellR}">${compEdp}</td></tr>` : ""}
            <tr><td style="${cellL}">Shop Rate</td><td style="${cellR}">$${fmtD(shopRate)}/hr</td></tr>
            <tr style="${rowGray}"><td style="${cellL}">Annual Volume</td><td style="${cellR}">${annualVolume ?? "—"} parts</td></tr>
          </table>
