...
Required fields (use 0 for unknown numbers, null for unknown strings):
{
  ...
  "cutting_material": <string, the workpiece material this tool is designed for. Look for "CUTTING=", "FOR:", "MATERIAL TO CUT:", "MAT'L:", or any similar callout in the NOTES section, title block, or geometry-callout area (e.g. "ALUMINUM GEOMETRY", "STEEL GEOMETRY"). Map the text to ONE of these keys EXACTLY:
    ...
    STEEL (P): "steel_alloy" (4130, 4140, 4340, 8620, 9310, chrom-moly, "alloy steel"); "steel_medium_carbon" (1040, 1045, 1055, 1070-1095, medium/high plain-carbon); "steel_mild" (A36, 1018, 1020, mild/low-carbon); "steel_free" (12L14, 1215, 1117, free-machining); "tool_steel_p20" (P20); "tool_steel_a2" (A2); "tool_steel_h13" (H13); "tool_steel_s7" (S7); "tool_steel_d2" (D2); "cpm_10v" (CPM 10V, A11, PM tool steel).
