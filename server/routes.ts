      ...
      <table role="presentation" width="620" cellpadding="0" cellspacing="0" style="width:620px;max-width:620px;background:#ffffff;border:1px solid #e5e7eb;">
        ...
        <tr><td style="padding:24px 28px;">
          ...
          ${(() => {
            ...
            rows.push(["Annual Volume", `${annualVolume ?? "—"} parts`]);
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:22px;border:1px solid #eee;">
            ...
            <tr>
              <td style="${cmpTd}color:#4b5563;">Tool Price</td>
              <td style="${cmpTd}color:#111827;text-align:right;font-weight:600;">$${fmtD(ccToolPrice)}</td>
              <td style="${cmpTd}color:#4b5563;text-align:right;">$${fmtD(compPrice)}</td>
            </tr>
            <tr style="${rowGray}">
              <td style="${cmpTd}color:#4b5563;">Parts per Tool</td>
              <td style="${cmpTd}color:#111827;text-align:right;font-weight:600;">${ccPartsPer ?? "—"}</td>
              <td style="${cmpTd}color:#4b5563;text-align:right;">${compPartsPer ?? "—"}</td>
            </tr>
            <tr>
              <td style="${cmpTd}color:#4b5563;">Time in Cut (min/part)</td>
              <td style="${cmpTd}color:#111827;text-align:right;font-weight:600;">${ccTimeInCut ?? "—"}</td>
              <td style="${cmpTd}color:#4b5563;text-align:right;">${compTimeInCut ?? "—"}</td>
            </tr>
            <tr style="${rowGray}">
              <td style="${cmpTd}color:#4b5563;">Tool Cost / Part</td>
              <td style="${cmpTd}color:#111827;text-align:right;font-weight:600;">$${fmtD(ccToolCost)}</td>
              <td style="${cmpTd}color:#4b5563;text-align:right;">$${fmtD(compToolCost)}</td>
            </tr>
            <tr>
              <td style="${cmpTd}color:#4b5563;">Machine Cost / Part</td>
              <td style="${cmpTd}color:#111827;text-align:right;font-weight:600;">$${fmtD(ccMachineCost)}</td>
              <td style="${cmpTd}color:#4b5563;text-align:right;">$${fmtD(compMachineCost)}</td>
            </tr>
            <tr bgcolor="#fff7ed" style="background:#fff7ed;">
              <td style="padding:10px 12px;font-size:13px;font-family:Arial,sans-serif;color:#111827;font-weight:700;border-top:2px solid #e5e7eb;">Total Cost / Part</td>
              <td style="padding:10px 12px;font-size:13px;font-family:Arial,sans-serif;color:#ea580c;font-weight:700;text-align:right;border-top:2px solid #e5e7eb;">$${fmtD(ccTotalCost)}</td>
              <td style="padding:10px 12px;font-size:13px;font-family:Arial,sans-serif;color:#4b5563;font-weight:700;text-align:right;border-top:2px solid #e5e7eb;">$${fmtD(compTotalCost)}</td>
            </tr>
          </table>
