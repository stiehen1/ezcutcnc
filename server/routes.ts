      ...
      if (smtpUser && smtpPass && userEmail) {
        ...
        const distributorBlockHtml = (distributorName && distributorName.trim())
          ? `<td style="vertical-align:top;text-align:right;">
              <p style="font-size:11px;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 6px;">Generated by</p>
              <p style="font-size:13px;color:#e5e7eb;font-weight:600;margin:0 0 3px;">${esc(distributorName.trim())}</p>
              ${distLines.map(l => `<p style="font-size:12px;color:#9ca3af;margin:0 0 2px;">${l}</p>`).join("")}
            </td>`
          : "";
...
<body style="font-family:Arial,sans-serif;background:#111;color:#e5e7eb;margin:0;padding:32px;">
  <div style="max-width:620px;margin:0 auto;background:#1c1c1c;border-radius:12px;overflow:hidden;">
    <div style="background:#ffffff;border-bottom:3px solid #ea580c;padding:18px 28px;">
      <table role="presentation" style="width:100%;border-collapse:collapse;">
        <tr>
          <td style="vertical-align:middle;width:150px;padding-right:18px;">
            <img src="https://corecutcnc.com/COREcutCNC_HORZ.png" alt="Core Cutter" width="150" style="width:150px;max-width:150px;height:auto;display:block;">
          </td>
          <td style="vertical-align:middle;text-align:right;">
            <div style="font-size:20px;font-weight:700;color:#1c1c1c;letter-spacing:-0.3px;">ROI Summary</div>
        ...
        <table role="presentation" style="width:100%;border-collapse:collapse;">
          <tr>
            <td style="vertical-align:top;">
              ...
              <p style="font-size:12px;color:#9ca3af;margin:0;">Web: <a href="https://corecutcnc.com" style="color:#fb923c;text-decoration:none;">corecutcnc.com</a></p>
            </td>
            ${distributorBlockHtml}
          </tr>
        </table>
        <p style="font-size:11px;color:#6b7280;margin:14px 0 0;">Generated by CoreCutCNC — figures are starting estimates for comparison.</p>
      </div>
    </div>
  </div>
</body>
