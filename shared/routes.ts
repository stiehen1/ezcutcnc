...
export const mentorSchemas = {
  input: z.object({
    ...
    spindle_taper: z.enum(["CAT30", "CAT40", "CAT50", "BT30", "BT40", "BT50", "HSK32", "HSK50", "HSK63", "HSK100", "HSK125", "VDI30", "VDI40", "VDI50", "BMT45", "BMT55", "BMT65", "CAPTO C6", "CAPTO C8", "KM80"]).default("CAT40"),
    spindle_drive: z.enum(["direct", "belt", "gear"]).default("belt"),
    machine_type: z.enum(["vmc", "hmc", "hbm", "5axis", "mill_turn", "lathe", "swiss", "double_column"]).default("vmc"),
