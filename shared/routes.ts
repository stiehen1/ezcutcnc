...
export const mentorSchemas = {
  input: z.object({
    ...
    reduce_wall_taper: z.boolean().default(false),  // legacy — kept for backwards compat; replaced by max_wall_taper_in
    max_wall_taper_in: z.number().min(0).max(0.05).default(0),  // target max wall taper (in). 0 = no target
    ...
    machine_type: z.enum(["vmc", "hmc", "hbm", "5axis", "mill_turn", "lathe", "swiss", "double_column", "gantry"]).default("vmc"),
    ...
    // Shop-measured PREFERRED stickout for this tool (SKU upload column). 0 = not
    // supplied → falls back to the geometric rule (floor + 0.20×D). Client-side this
    // is what "Restore default" restores to.
    pref_stickout_override: z.number().min(0).default(0),
  ...
  response: z.object({
    ...
    chamfer: z.object({
      ...
      lead_ctf: z.number().optional(),
      chip_thin_factor: z.number().optional(),
      base_chip_in: z.number().optional(),
      radial_reach_in: z.number().optional(),
      edge_length_in: z.number().optional(),
      max_depth_in: z.number().optional(),
      edge_pct: z.number().optional(),
      actual_woc_in: z.number().optional(),
      woc_pct_d_eff: z.number().optional(),
      std_flutes: z.array(z.number()).optional(),
      flute_nonstandard: z.boolean().optional(),
      chip_room_mult: z.number().optional(),
      max_rough_depth_in: z.number().optional(),
      cmh_shear_angle_deg: z.number().nullable().optional(),
      cmh_sfm_boost_pct: z.number().nullable().optional(),
      cmh_force_factor: z.number().nullable().optional(),
      cmh_min_ipt: z.number().nullable().optional(),
      cmh_min_ipt_ok: z.boolean().nullable().optional(),
    }).nullable().optional(),
    ...
    dovetail: z.object({
      ...
      max_safe_doc_in: z.number().optional(),
      flute_reach_in: z.number().optional(),
      effective_flute_reach_in: z.number().optional(),
      ...
      multi_pass: z.object({
        ...
        max_safe_doc_in: z.number(),
        aggressive: z.boolean(),
        head_neck_ratio: z.number().optional(),
        head_factor: z.number().optional(),
        mat_factor: z.number().optional(),
        reach_factor: z.number().optional(),
        direction_strategy: z.string().optional(),
        pre_rough: z.object({
          stock_per_side_in: z.number(),
          slot_width_in: z.number(),
          endmill_dia_in: z.number(),
          axial_depth_in: z.number().nullable().optional(),
          note: z.string(),
        }).optional(),
        passes: z.array(z.object({
          index: z.number(),
          depth_in: z.number(),
          cumulative_in: z.number(),
          side_a_direction: z.string(),
          side_b_direction: z.string(),
          is_finish: z.boolean(),
          note: z.string(),
        })).optional(),
      }).nullable().optional(),
    ...
    entry_moves: z.object({
      ...
      sweep_arc_radius_min_in:  z.number().optional(),
      sweep_arc_radius_rec_in:  z.number().optional(),
      sweep_entry_ipm:          z.number().optional(),
      sweep_full_ipm:           z.number().optional(),
      // Straight entry
      straight_entry_ipm:       z.number().optional(),
      // Entry caution
      entry_caution:            z.string().nullable().optional(),
      entry_feed_pct:           z.number().optional(),
    }).nullable().optional(),
