...
export const mentorSchemas = {
  input: z.object({
    ...
    spindle_taper: z.enum(["CAT30", "CAT40", "CAT50", "BT30", "BT40", "BT50", "HSK32", "HSK50", "HSK63", "HSK100", "VDI30", "VDI40", "VDI50", "BMT45", "BMT55", "BMT65", "CAPTO C6", "CAPTO C8"]).default("CAT40"),
    ...
    workholding: z.enum(["rigid_fixture", "tombstone", "dovetail", "vise", "soft_jaws", "toe_clamps", "5th_axis_vise", "3_jaw_chuck", "4_jaw_chuck", "6_jaw_chuck", "collet_chuck", "between_centers", "face_plate", "trunnion_4th", "expanding_mandrel", "sub_spindle", "tailstock_supported", "ijaw", "autochuck", "zero_point", "pyramid"]).default("vise"),
