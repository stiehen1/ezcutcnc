...
- **Chatter-risk mitigation tips.** When a pocket tool flags Chatter Risk (≥100% of the deflection limit), the card now shows a short, **actionable** list of ways to steady that specific tool — shorten stickout / reduced-neck (if L/D is high), a more rigid holder (if on a collet/weldon), lighter WOC, or a shallower axial step — cheapest/most-effective first. Amber for Chatter Risk, red with a "reduce before running" header at ≥175%.
